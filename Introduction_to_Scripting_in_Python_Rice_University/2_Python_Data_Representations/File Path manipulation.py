...
def run_absolute_path_examples():
    ...
    current_abs_path = r"C:\Users\Graham\Google Drive\Python\Introduction to Scripting in Pyhton - RICE University\Python Data Representations\paths\current_file.txt"
    child_abs_path = r"C:\Users\Graham\Google Drive\Python\Introduction to Scripting in Pyhton - RICE University\Python Data Representations\paths\child\child_file.txt"
    parent_abs_path = r"C:\Users\Graham\Google Drive\Python\Introduction to Scripting in Pyhton - RICE University\Python Data Representations\parent_file.txt"
